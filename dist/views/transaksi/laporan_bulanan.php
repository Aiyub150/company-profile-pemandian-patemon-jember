                ...
                <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3">
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-2">
                        ...
                        <div class="d-flex gap-2">
                            <?php 
                            $b_m = (int)date('n', strtotime($dateInput . '-01'));
                            $b_y = (int)date('Y', strtotime($dateInput . '-01'));
                            ?>
                            <a href="<?= route_url('laporan_preview', ['tipe' => 'bulanan', 'month' => $b_m, 'year' => $b_y]) ?>" class="btn btn-outline-secondary btn-sm px-3 shadow-sm bg-white" title="Pratinjau Dokumen Cetak Standar Pemkab">
